...
-- easier insert to normal switch than ESC
vim.keymap.set("i", "jj", "<Esc>", { desc = "Simpler switch from insert to normal" })
	...
	},
	{
		...
		config = function()
			...
			local servers = {
				...
				rust_analyzer = {
					-- Mason version is busted 2025-7-7
